...
package dev.server.boards.rules.upstream.chesslib;
...
import static dev.server.boards.rules.upstream.chesslib.Bitboard.extractLsb;
import static dev.server.boards.rules.upstream.chesslib.Constants.emptyMove;
import static dev.server.boards.rules.upstream.chesslib.Constants.POLYGLOT_RANDOM_TABLE;
import dev.server.boards.rules.upstream.chesslib.game.GameContext;
import dev.server.boards.rules.upstream.chesslib.game.VariationType;
import dev.server.boards.rules.upstream.chesslib.move.Move;
import dev.server.boards.rules.upstream.chesslib.move.MoveGenerator;
import dev.server.boards.rules.upstream.chesslib.move.MoveList;
import dev.server.boards.rules.upstream.chesslib.util.XorShiftRandom;
