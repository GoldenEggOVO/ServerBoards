...
package dev.server.boards.rules.upstream.chesslib.move;

import java.util.LinkedList;
import java.util.List;

import dev.server.boards.rules.upstream.chesslib.Bitboard;
import static dev.server.boards.rules.upstream.chesslib.Bitboard.bitScanForward;
...
import dev.server.boards.rules.upstream.chesslib.CastleRight;
import dev.server.boards.rules.upstream.chesslib.Piece;
import dev.server.boards.rules.upstream.chesslib.PieceType;
import dev.server.boards.rules.upstream.chesslib.Rank;
