...
import static dev.server.boards.rules.upstream.chesslib.DiagonalA1H8.*;
import static dev.server.boards.rules.upstream.chesslib.DiagonalH1A8.*;
import static dev.server.boards.rules.upstream.chesslib.Square.*;
